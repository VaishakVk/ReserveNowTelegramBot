...
class MainPage(webapp2.RequestHandler):
    def post(self):
		...
		list_greetings = ['Hello', 'Hi', 'Hii', 'Howdy', 'Oi', 'Ey', 'Hey', 'Heyy', 'Oii']
		...
		list_response_success = ['Congrats!! We have successfully reserved a table for you.', 'Great News!! You table booking is confirmed.', 'Well!! We have booked the required table for you.']
